...
infile5 <- tempfile()
download.file(inUrl5,infile5,method="curl")
...
infile6 <- tempfile()
download.file(inUrl6,infile6,method="curl")
...
library(tidyverse)
write_csv(dt1, 'CalCOFI_transect.csv')
write_csv(dt2, 'CalCOFI_obs.csv')
write_csv(dt3, 'NMFS_transect.csv')
write_csv(dt4, 'NMFS_obs.csv')
write_csv(dt5, 'CPR_transect.csv')
write_csv(dt6, 'CPR_obs.csv')
